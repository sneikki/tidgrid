...
{% capture result %}
    <div class="tg-row tg-y-gap(xl)">
        <div class="tg-cell">
            <div class="tg-row tg-mode(thin) tg-space(between) tg-x-gap(lg)">
                <div class="tg-cell">
                    <div class="features__box"></div>
                </div>
        ...
        <div class="tg-cell">
            <div class="tg-row tg-mode(thin) tg-space(evenly) tg-x-gap(lg)">
                <div class="tg-cell">
                    <div class="features__box"></div>
                </div>
...
{% include feature.html
    title="Spacing & positioning made easy"
    source=source
    result=result %}
